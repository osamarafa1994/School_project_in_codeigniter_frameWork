  ...
  <?php echo form_open('Users_admin/update_user/'.$user->user_id , 'class="email"  id="form"'); ?>
  <div class="row">
    ...
    <div class="form-group">
      <input type="text" class="form-control" id="username_form" name="user_name" value="<?= $user->user_name ?>" placeholder="ادخل اسم المستخدم">
